...
MBTI(44题/维度)、XP测试、发疯指数、大五人格(30题/factor)、暗黑人格(27题/factor)、恋爱人格、
性压抑指数、阴阳怪气浓度、废柴天赋、依恋风格、社交人格、单身力、天赋能力、职场角色、情商测评、
职场倦怠、宠物人格、憨憨指数、内耗指数、睡眠质量、精神年龄、手机依赖、恋爱脑、吵架风格、
分手风格、心动信号、办公室角色、老板风格、Chiikawa 缘分。

Chiikawa 缘分测试（`chiikawa-bond`）：32 题 × 每题 4 个短选项；八个角色的总曝光、选项位置和角色组合近似平衡。总票平局时比较末 8 题，仍平局才按定义顺序兜底；内容为娱乐向角色匹配，不构成专业评价。
...
全部测试 notice 为趣味/非医疗声明口径，不含免费或付费提示（付费解锁 M4+ 视资质再启）。
