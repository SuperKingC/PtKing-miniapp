...
const jobs = [
  { name: 'test-hero-clay-v1.png' },
  { name: 'tile-mbti-v1.png' },
  { name: 'tile-personality-v1.png' },
  { name: 'tile-love-v1.png' },
  { name: 'tile-career-v1.png' },
  { name: 'tile-fun-v1.png' },
  { name: 'icon-bell-v1.png' },
  { name: 'tarot-hero-v2.jpg', source: 'tarot-hero-v2.png', convert: true },
  { name: 'tarot-card-single-v1.png' },
  { name: 'tarot-cards-fan-v1.png' },
  { name: 'records-book-v2.png' },
]
...
for (const job of jobs) {
  ...
  const input = fs.readFileSync(path.join(root, 'prepared', sourceName.includes('_floodfill') ? path.join('floodfill', sourceName) : sourceName))
  let auth
  if (!state[job.name]) {
