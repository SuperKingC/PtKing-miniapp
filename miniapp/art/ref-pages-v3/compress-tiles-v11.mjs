// 一次性：TinyPNG 压缩 v11 两枚修正 tile（prepared/ → src/assets/illus，升版文件名）
// v10 的 career/fun 合成接触影方向反了（AFFINE 输入输出坐标混淆），v11 修正为下方向。
...
const files = ['tile-career-v11.png', 'tile-fun-v11.png']
