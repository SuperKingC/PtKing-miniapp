// 一次性：TinyPNG 压缩 v20 两枚 tile（prepared/ → src/assets/illus，升版文件名）
// v13 修黑晕边时把 body 外全部像素混向页面白，连带洗掉了烘焙接触影；
// v18 几何AA修边，v19 移植参考 baked 影只铺直边段，v20 去掉板面顶/右缘的淡黄受光带。
...
const files = ['tile-fun-v20.png', 'tile-career-v20.png']
