// 一次性：TinyPNG 压缩 v12 两枚修正 tile（prepared/ → src/assets/illus，升版文件名）
// v11 只修了上下翻转仍绕卡一圈；v12 按参考 star-v10 烘焙影实测改为方向性投影（左3px+下5px+σ2.8+α0.45）。
...
const files = ['tile-career-v12.png', 'tile-fun-v12.png']
