// 一次性：TinyPNG 压缩 v23 两枚 tile（prepared/ → src/assets/illus，升版文件名）。
// v23 的主体/外部影由 compose-tiles-v23.py 生成；这里仅负责压缩和落包，不改图。
...
const keys = ['TINYPNG_API_KEY', 'TINYPNG_API_KEY_2', 'TINYPNG_API_KEY_3']
  ...
  .filter(Boolean)
const files = ['tile-fun-v23.png', 'tile-career-v23.png']
