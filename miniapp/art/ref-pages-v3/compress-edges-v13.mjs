// 一次性：TinyPNG 压缩四项视觉修复产物（prepared/ -> src/assets/illus，升版文件名）。
// 输入 prepared/ 由 fix-asset-edges-final.py 生成。
...
const files = ['tile-fun-v13.png', 'tile-career-v13.png', 'me-banner-panel-v5.png', 'hero-card-v8.png']
