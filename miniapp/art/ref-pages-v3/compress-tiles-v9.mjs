// 一次性：TinyPNG 压缩 LUT 调色后的 5 枚 tile（就地覆盖 src/assets/illus 里的 v8/v7/v4/v8 文件）
...
const files = ['tile-mbti-v9.png', 'tile-love-v8.png', 'tile-star-v8.png', 'tile-career-v5.png', 'tile-fun-v9.png']
for (const name of files) {
  const input = fs.readFileSync(path.join(srcRoot, name))
  let done = false
