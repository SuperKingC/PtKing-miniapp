// 一次性：TinyPNG 压缩 v10 五枚 tile（prepared/ → src/assets/illus，升版文件名）
...
const files = ['tile-mbti-v10.png', 'tile-love-v10.png', 'tile-star-v10.png', 'tile-career-v10.png', 'tile-fun-v10.png']
