...
const jobs = [
  { name: 'me-banner-panel-v2.jpg', source: 'me-banner-refpanel.png', convert: true },
  { name: 'icon-me-clear-v7.png', source: 'ref-clear.png' },
  { name: 'icon-me-privacy-v7.png', source: 'ref-privacy.png' },
  { name: 'icon-me-share-v7.png', source: 'ref-share.png' },
  { name: 'icon-me-feedback-v7.png', source: 'ref-feedback.png' },
  { name: 'icon-me-theme-v7.png', source: 'ref-theme.png' },
  { name: 'icon-me-haptics-v7.png', source: 'ref-haptics.png' },
]
