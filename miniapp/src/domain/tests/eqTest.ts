...
/**
 * 情商测评（band 模式）：8 题、每题 0-3 分四档，总分 0-24 落三档。
...
export const EQ_TEST: TestDefinition = {
  ...
  intro: [
    ...
    '8 道日常沟通场景题（反向计分：越少踩坑越高分），看看你的情商账户余额。',
  ],
  ...
  scoring: {
    ...
    max: 24,
    bands: [
      { min: 0, max: 8, reportId: 'eq-high' },
      { min: 9, max: 16, reportId: 'eq-mid' },
      { min: 17, max: 24, reportId: 'eq-grow' },
    ],
  },
  reports: {
    'eq-high': {
