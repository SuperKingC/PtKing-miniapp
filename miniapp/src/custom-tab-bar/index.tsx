...
import testIcon from '../assets/tabbar/icon-tab-test-v17s.png'
import testActiveIcon from '../assets/tabbar/icon-tab-test-active-v17s.png'
import tarotIcon from '../assets/tabbar/icon-tab-tarot-v18s.png'
import tarotActiveIcon from '../assets/tabbar/icon-tab-tarot-active-v18s.png'
import recordsIcon from '../assets/tabbar/icon-tab-records-v17s.png'
import recordsActiveIcon from '../assets/tabbar/icon-tab-records-active-v17s.png'
import meIcon from '../assets/tabbar/icon-tab-me-v17s.png'
import meActiveIcon from '../assets/tabbar/icon-tab-me-active-v17s.png'
