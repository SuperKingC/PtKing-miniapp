...
import testIcon from '../assets/tabbar/icon-tab-test-v13s.png'
import testActiveIcon from '../assets/tabbar/icon-tab-test-active-v13s.png'
import tarotIcon from '../assets/tabbar/icon-tab-tarot-v13s.png'
import tarotActiveIcon from '../assets/tabbar/icon-tab-tarot-active-v13s.png'
import recordsIcon from '../assets/tabbar/icon-tab-records-v13s.png'
import recordsActiveIcon from '../assets/tabbar/icon-tab-records-active-v13s.png'
import meIcon from '../assets/tabbar/icon-tab-me-v13s.png'
import meActiveIcon from '../assets/tabbar/icon-tab-me-active-v13s.png'
