...
2026-09-09 用户选定 `art/generated-art/me-heal-preview-ui/ui-4.png` 为全包插画锚点。后续生图、改版、换图必须贴合，禁止退回扁平矢量色块、水彩勾线、彩铅排线。

- 造型：软陶 / 毡面 3D 小物件（claymorphism），圆润可触摸，细腻纸纹与毡面颗粒，柔和体积光影，无硬描边。
- 色板：奶油白、燕麦 `#f7f4ee`、米色胶囊 `#e9dfd0`、雾蓝、陶土橘、浅金褐。
- 「我的」品牌栏：雾蓝圆角卡 + 奶油猫坐桃色月牙；「测测子」「来测测你的另一面」必须画进图，禁止 CSS 叠字。
